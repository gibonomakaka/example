            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <p>Тип одежды</p>
                        <select name="sex">
                            <option value="мужская" <?php if ($product['sex'] == "мужская") echo ' selected="selected"'; ?>>Мужская</option>
                            <option value="женская" <?php if ($product['sex'] == 'женская') echo ' selected="selected"'; ?>>Женская</option>
                        </select>
